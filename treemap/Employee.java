 ...
 * TreeMap Naturally Sorts the data By implicitly calling compareTo method.
 */
public class Employee {
	...
	public static void main(String[] args) {
		...
		while (iterator.hasNext()) {
			...
			System.out.println(
					"The Employee ID is: " + details.getKey() + "   The Employee Name is: " + details.getValue());
		}
	}
}
 ...
 */
/*
 * The Employee ID is: 102 The Employee Name is: Gireesh The Employee ID is: 107
 * The Employee Name is: Anirudh The Employee ID is: 109 The Employee Name is:
 * Lohith The Employee ID is: 110 The Employee Name is: Jeevan
 */